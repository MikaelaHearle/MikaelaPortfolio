...
import resume from '../assets/images/MikaelaHearleENG.pdf';
import cv from '../assets/images/MikaelaHearle.pdf';
</script>
...
.about-me__image {
  border: solid 8px rgb(190, 159, 50);
  border-radius: 50%;
}

.about-me__link {
  text-decoration: underline;
  color: rgb(190, 159, 50);
}
</style>
